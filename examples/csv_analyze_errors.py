...
from arekit.common.data.const import ENTITIES, ENTITY_VALUES, ENTITY_TYPES
...
def __post_text_processing(sample_row, source_ind, target_ind):
    """ Пост-обработка текста для лучшего понимания возможных
        возникающих проблем в анализе текста.
    """
